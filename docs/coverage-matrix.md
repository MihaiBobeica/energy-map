...
> Electricity generation is published from 2000 because the pre-2000 span
> derives from the Energy Institute, whose redistribution terms are not
> verified (see the source register); the source itself reaches back to 1985.
...
| Electricity demand                           | `owid-electricity-demand`                    | 1990                                  | 2025              | annual                        | country                  | 196 (2024); 91 in partial 2025 | observed       | verified              | 2026-08-05 |
